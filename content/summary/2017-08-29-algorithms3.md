...
layout: post
published: true
title: Algorithms, Part 3(Graphs)
author:
    - Sanjoy DasGupta
use_math: true
...
*Connectivity in unidirected graphs*
![alt](/images/algdg/3_cc.png)
Identify and assign different integers to the different connected components in a unidirected Graph.

*Previsit and Postvisit orderings*
![alt](/images/algdg/3_previsit.png)

**Property :** *For any node $$u$$ and $$v$$, the two intervels $$[pre(u), post(u)]$$ and $$[pre(v), post(v)]$$ are either disjoint or one is contained within the other.*   
...
The resulting algotihm,   
1. Run depth-first search on $G^R$$.
2. Run the undirected connected components algorithm on $$G$$m and during the depth-first search, process the vertices in decreasing order of their *post* numbers. from step 1.
